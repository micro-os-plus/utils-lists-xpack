...
title: µOS++ Intrusive Lists v4.0.1 released
seo_title: Version 4.0.1 released
description: Version v4.0.1 is a maintenance release
keywords:
  - micro-os-plus
  - xpack
  - utils-lists
...
release_tag_url: "https://github.com/micro-os-plus/utils-lists-xpack/tree/v4.0.1"
...
Version **4.0.1** is a maintenance release; it silences some warnings and updates RPATH processing.
