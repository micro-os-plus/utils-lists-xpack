...
{/* docusaurus-template-liquid/templates/common/docs/install/_common/_installation-details-liquid.mdx */}
...
* identify the desired version
  of @micro-os-plus/utils-lists, download it into a cache and unpack
...
* create a local symbolic link
  such as <code>xpacks/@micro-os-plus/utils-lists</code> pointing to the
  versioned folder in the user's global xPacks store
* add <code>@micro-os-plus/utils-lists</code> to
  `package.json` as a
  dependency; this associates a specific version of µOS++ Intrusive Lists with
