...
{/* docusaurus-template-liquid/templates/common/docs/maintainer/_common/_micro-os-plus/_content-liquid.mdx */}
...
- Execute the **trigger-workflow-test-all** action
  ```sh
  xpm run trigger-workflow-test-all -C ~/Work/micro-os-plus/utils-lists-xpack.git/tests
  ```
