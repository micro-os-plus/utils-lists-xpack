...
{/* docusaurus-template-liquid/templates/common/docs/maintainer/_common/_prepare-new-blog-post-liquid.mdx */}
...
- Execute the **generate-website-blog-post** npm script; this will add a file to the `website/blog` folder:
  ```sh
  npm --prefix ~/Work/micro-os-plus/utils-lists-xpack.git/website run generate-website-blog-post
  ```
...
- Add entries in the **Bug fixes**; utilise the following syntax
  ```
  - [[#N](https://github.com/micro-os-plus/utils-lists-xpack/issues/N)]:
  ```
- **Commit** with the message _**website: blog post release 5.0.0 published**_
