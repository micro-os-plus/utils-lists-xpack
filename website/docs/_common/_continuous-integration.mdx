...
{/* docusaurus-template-liquid/templates/common/docs/_common/_micro-os-plus/_continuous-integration-liquid.mdx */}

{/* ------------------------------------------------------------------------ */}

The library is subject to continuous integration (CI) testing with every
push utilising [GitHub Actions](https://github.com/micro-os-plus/utils-lists-xpack/actions).
