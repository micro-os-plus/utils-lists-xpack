...
- name the file like `2020-12-19-utils-lists-v0-1-0-released.md`
- name the post like: **µOS++ utils-lists v0.1.0 released**
...
- `npm dist-tag add @micro-os-plus/utils-lists@0.1.0 latest`
- `npm dist-tag ls @@micro-os-plus/utils-lists`
...
- paste the release name like **µOS++ utils-lists v0.1.0 released**
