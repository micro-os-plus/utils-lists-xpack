...
- name the post like: **µOS++ utils-lists v2.0.0 released**
...
- `npm dist-tag add @micro-os-plus/utils-lists@2.0.0 latest`
- `npm dist-tag ls @@micro-os-plus/utils-lists`
...
- paste the release name like **µOS++ utils-lists v2.0.0 released**
